...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "KUM Services GmbH — autonomous aircraft conversion specialist. Civil aircraft converted to autonomous platforms for defence and government operators.",
    images: [{ url: absoluteUrl(OG_IMAGE), width: 1200, height: 630, alt: "Autonomous Aircraft Germany — KUM Services GmbH" }],
  },
  twitter: {
    ...
    "@graph": [
      {
        ...
        "@id": `${base}${CANONICAL}`,
        url: `${base}${CANONICAL}`,
        name: "Autonomous Aircraft Germany — KUM Services GmbH",
        description:
    ...
    <>
      ...
      <section className="section">
        ...
        <p className="section-lead">
          KUM Services GmbH delivers autonomous aircraft
      ...
      <div className="callout-strip reveal">
        ...
        <div className="callout-img" style={{ order: 2 }}>
          <Image
            ...
            alt="Autonomous aircraft conversion programme — KUM Services GmbH Germany"
      ...
      <section className="section">
        ...
        >
          {[
            ...
            { src: "/theme/hpaa4.jpg", alt: "Autonomous aircraft platform — civil to HPAA conversion, Germany", label: "HPAA Platform" },
          ].map((img) => (
      ...
      <section className="section" style={{ textAlign: "center" }}>
        ...
        <p className="section-lead" style={{ margin: "1rem auto 2rem", maxWidth: 560 }}>
          KUM Services GmbH — autonomous aircraft conversion programmes for
