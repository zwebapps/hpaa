...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "KUM Services GmbH — high-performance combat drone specialist. Civil aircraft converted to combat-capable autonomous platforms for defence and government customers.",
    images: [{ url: absoluteUrl(OG_IMAGE), width: 1200, height: 630, alt: "High-Performance Combat Drones Germany — KUM Services GmbH" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "High-Performance Combat Drones Germany | KUM Services GmbH",
    description: "Civil aircraft to high-performance combat drone conversion in Germany.",
    ...
    "@graph": [
      {
        ...
        "@id": `${base}${CANONICAL}`,
        url: `${base}${CANONICAL}`,
        name: "High-Performance Combat Drones Germany — KUM Services GmbH",
        description:
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "High-performance combat drones in Germany are civil-registered aircraft converted to combat-capable autonomous platforms by KUM Services GmbH. These platforms are configured for precision strike, ISR, loitering munitions, counter-UAS, and attritable attack missions. The HPAA (High Performance Autonomous Aircraft) conversion approach delivers combat drone capability significantly faster and at lower cost than purpose-built UCAV programmes.",
            },
          },
          {
            "@type": "Question",
    ...
    <>
      ...
      <div className="callout-strip reveal">
        <div className="callout-img">
          <Image
            fill
            src="/theme/hpaa5.jpg"
            alt="High-performance combat drone platform — KUM Services GmbH Germany"
      ...
      <section className="section" style={{ textAlign: "center" }}>
        ...
        <p className="section-lead" style={{ margin: "1rem auto 2rem", maxWidth: 560 }}>
          KUM Services GmbH — high-performance combat drone conversion
