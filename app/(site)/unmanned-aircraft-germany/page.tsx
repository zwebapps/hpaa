...
export const metadata: Metadata = {
  ...
  description:
    "Unmanned aircraft Germany: KUM Services GmbH converts proven civil turboprop and turbofan aircraft into unmanned autonomous platforms for ISR, cargo, strike and special missions. EASA Part-145 certified. Faster and lower cost than purpose-built UAS programmes.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "KUM Services GmbH — unmanned aircraft conversion specialist. Civil turboprop and turbofan aircraft converted to fully unmanned autonomous platforms for defence and government.",
    images: [{ url: absoluteUrl(OG_IMAGE), width: 1200, height: 630, alt: "Unmanned Aircraft Germany — KUM Services GmbH" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Unmanned Aircraft Germany | KUM Services GmbH",
    description: "Civil aircraft to unmanned platform conversion in Germany.",
    ...
    "@graph": [
      {
        ...
        "@id": `${base}${CANONICAL}`,
        url: `${base}${CANONICAL}`,
        name: "Unmanned Aircraft Germany — KUM Services GmbH",
        description:
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "Unmanned aircraft conversion in Germany is the process of converting a civil-registered turboprop or turbofan aircraft into a fully unmanned aerial system (UAS/UAV). KUM Services GmbH (Germany) performs manned-to-unmanned conversions using EASA Part-145 certified procedures, delivering operational unmanned aircraft capability significantly faster and at lower cost than purpose-built UAS programmes.",
            },
          },
          {
            "@type": "Question",
    ...
    <>
      ...
      <section className="section">
        ...
        <p className="section-lead">
          KUM Services GmbH converts proven civil-registered turboprop
      ...
      <div className="callout-strip reveal">
        <div className="callout-img">
          <Image
            fill
            src="/theme/hpaa7.jpg"
            alt="Unmanned aircraft autonomous platform — KUM Services GmbH Germany"
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        ...
        >
          {[
            ...
            { src: "/theme/pilatus-pc-12-1.png", alt: "Pilatus PC-12 unmanned aircraft platform — KUM Services GmbH Germany", label: "Pilatus PC-12" },
      ...
      <section className="section" style={{ textAlign: "center" }}>
        ...
        <p className="section-lead" style={{ margin: "1rem auto 2rem", maxWidth: 560 }}>
          KUM Services GmbH — unmanned aircraft conversion programmes for
